      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between py-3">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-md group-hover:scale-105 transition-transform duration-200">
              <span className="font-bold text-lg tracking-tight">MT</span>
            </div>
            <div className="flex flex-col">
              <span className="text-slate-900 font-bold text-xl leading-none tracking-tight">MediTrack</span>
              <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500 font-bold mt-1">Real-Time Care</span>
            </div>
          </Link>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  <div className="flex flex-col items-end mr-1">
                     ...
                     <span className="text-sm font-bold text-slate-800 leading-none">{getUsername()}</span>
                  </div>
